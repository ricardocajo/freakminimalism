    ...
    .then(data => {
      Object.keys(data).forEach(key => {
        if (data[key]) {
          ...
          listItem.innerHTML = `<a class="mx-2" href="https://api.whatsapp.com/send?phone=351927771505&amp;text=Quero%20esta%20merch!%20${ABSOLUTE_PATH}/db/works/img/${key}" target="_blank"><img class="workscenter-fit" src=${ABSOLUTE_PATH}/db/works/img/${key} alt="..."><p style="font-size: 14px;">Encomendar!</p></a>`;
    ...
    .then(data => {
      Object.keys(data).forEach(key => {
        if (data[key]) {
          ...
          listItem.classList.add("column-item");
          if(key == '0.jpg') {
            listItem.innerHTML = `<a class="mx-2" href="https://api.whatsapp.com/send?phone=351927771505" target="_blank"><img class="workscenter-fit" src=${ABSOLUTE_PATH}/db/designs/img/${key} alt="..."><p style="font-size: 14px;">Encomendar!</p></a>`;
          } else {  
            listItem.innerHTML = `<a class="mx-2" href="https://api.whatsapp.com/send?phone=351927771505&amp;text=Quero%20este%20design!%20${ABSOLUTE_PATH}/db/designs/img/${key}" target="_blank"><img class="workscenter-fit" src=${ABSOLUTE_PATH}/db/designs/img/${key} alt="..."><p style="font-size: 14px;">Encomendar!</p></a>`;
          }
          works_DOM.appendChild(listItem);
